...
INSERT INTO users (username,password,enabled) values ('user','{bcrypt}$2a$10$1NlAadvdSS17F4..0rP.B.63I90zEsBklZjTrxr0FzoXcIizUfWn.',true);
INSERT INTO users (username,password,enabled) values ('admin','{bcrypt}$2a$10$1NlAadvdSS17F4..0rP.B.63I90zEsBklZjTrxr0FzoXcIizUfWn.',true);
